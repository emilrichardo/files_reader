    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:hidden z-50">
        ...
        {!loading &&
          (user ? (
            <div className="flex items-center">
              <span className="text-sm mr-2 max-w-[100px] truncate">{user.name}</span>
              <Button variant="ghost" size="icon" onClick={signOut} className="rounded-full w-8 h-8 overflow-hidden">
            ...
            <Button variant="outline" size="sm" onClick={signInWithGoogle} className="flex items-center text-xs">
