              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="projectName"
                    name="projectName"
                    value={localConfig.projectName || "Civet"}
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={localConfig.colorScheme || "blue"}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={localConfig.fontFamily || "Inter"}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={localConfig.styleMode || "flat"}
                ...
                <div className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center gap-2">
                    {logoPreview ? (
                      ...
                      >
                        {(localConfig.projectName || "C").charAt(0)}
                      </div>
                    )}
                    <span className="font-bold">{localConfig.projectName || "Civet"}</span>
                  </div>
